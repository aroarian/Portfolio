...
var snowStorm = (function(window, document) {
    ...
    this.flakeBottom = 500;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
    ...
    this.targetElement = "topContent";      // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
